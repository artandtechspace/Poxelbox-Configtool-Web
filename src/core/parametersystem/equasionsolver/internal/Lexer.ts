import { isValidFirstCharacter, isValidMiddleCharacter } from "../../ParameterSystemChecks"
import { TheParameterSystem } from "../../TheParameterSystem";
import type { NumberToken, Token } from "./Token";
...
export class Lexer {
     ...
     * @returns the number-token that got parsed
     * 
     * @throws {string} the error message if the parameter does not exist
     */
    private makeParameter() : NumberToken{
        ...
        // Gets the parameter
        // TODO: Lagnuage ref
        var value = TheParameterSystem.getParameterByName(prmName);
